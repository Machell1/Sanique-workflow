...
export function formatProvenanceBlock(p: ProvenanceFacts): string {
  return [
    ...
    'PROVENANCE',
    '— — — — — — — — — — — — — — — — — — — — — — — — — — — — — — —',
    `Application       Sanique's workspace v${p.appVersion}`,
    ...
    'It proves the file you are holding is identical to what the workspace',
    'produced at the timestamp above. Any edit made in a word processor',
    'after export invalidates this seal. To verify, re-hash the body of this',
    'document and compare against the value above; or cross-check the',
    'document ID against the workspace audit ledger.',
    '— — — — — — — — — — — — — — — — — — — — — — — — — — — — — — —',
  ].join('\n');
}
